...
| _Galaxy Language Server_ | [Galaxy Project](https://github.com/galaxyproject) | [galaxy-language-server](https://github.com/galaxyproject/galaxy-language-server) | Language Server for [Galaxy](https://galaxyproject.org/) Tool Wrappers |
