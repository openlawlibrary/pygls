...
async def test_type_definition(
    ...
    type_definition_options = initialize_result.capabilities.type_definition_provider
    assert type_definition_options is True
    ...
    response = await client.text_document_type_definition(
